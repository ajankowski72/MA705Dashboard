...
app.layout = html.Div([
    ...
    dcc.Dropdown(
            options=[
            {'label': 'Super Bowl Locations by State', 'value': 'State'},
            {'label': 'Super Bowl Locations by City', 'value': 'City'},
            {'label': 'Super Bowls by Winning Score', 'value': 'Winner Points'},
            {'label': 'Super Bowls by Losing Score', 'value': 'Loser Points'},
            {'label': 'Super Bowls by Margin of Victory', 'value': 'Margin of Victory'},
            {'label': "Super Bowl MVP's by Player", 'value': 'MVP'},
            {'label': "Super Bowl MVP's by Position", 'value': 'MVP Position'}
        ],
        value='State',
        id = 'my_dropdown',
        multi=False,
